        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitWeight = table.Column<int>(type: "INTEGER", nullable: false),
                    CurrentWeight = table.Column<int>(type: "INTEGER", nullable: false),
                    LocationDesc = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodPallets", x => x.ItemID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ItemsReceiving = table.Column<string>(type: "TEXT", nullable: true),
                    LastAppointmentDate = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
